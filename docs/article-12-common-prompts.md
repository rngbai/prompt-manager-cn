# 都Agent时代了，我还是想分享给你这12个我最常用的 Prompt

> 来源：数字生命卡兹克
>
> 发布时间：2026年8月21日 08:08
>
> 原文链接：https://mp.weixin.qq.com/s/NAdhdFrUq9-BKelqzqpwBQ

## 文章摘要

文章将日常使用 AI 的方法整理为五类：问清问题、学习、解决问题、决策、认识自己。提示词均可单独使用，把全角方括号中的内容替换成自己的信息，并尽量附上已有文档、数据或其他原始材料。
...
1. 先替换提示词中的【】占位内容。
2. 涉及研究、事实核查和决策时，附上原始资料，并要求 AI 区分事实、推断和观点。
3. 长对话类提示词需要连续回答，不要只看第一轮输出。
