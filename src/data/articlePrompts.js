// 精选自公众号文章《都Agent时代了，我还是想分享给你这12个我最常用的Prompt》
// 固定 uuid 让扩展更新时只补充缺失项，不覆盖用户已有提示词。
export const DEFAULT_PROMPTS = [
  {
    "uuid": "wechat-12-prompts-01",
    "title": "苏格拉底式提问",
