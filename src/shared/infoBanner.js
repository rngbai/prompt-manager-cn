...
export function buildInfoBannerHtml() {
  return `<span><strong>新增：</strong>分享和导入社区提示词 <a href="${OPD_CHANGELOG_URL}" target="_blank" rel="noopener noreferrer" class="opm-info-banner-link">了解更多</a></span>`;
}
...
export async function mountSidepanelInfoBanner(hostEl) {
  ...
  banner.innerHTML = `
    ...
    <button type="button" class="sidebar-info-banner-close" aria-label="关闭更新提示">&times;</button>
  `;
